...
import { assertLeafCategory } from './categories.js';

// Logic behind api/messages/index.js, which dispatches list/get/update on
...
export async function listMessages(user, req, res) {
  const {
    mailbox = 'inbox',
    category,
    account,
...
export async function getOrUpdateMessage(user, id, req, res) {
  ...
  if (body.categoryId !== undefined && body.categoryId !== null) {
    await assertLeafCategory(user.id, body.categoryId);
  }
