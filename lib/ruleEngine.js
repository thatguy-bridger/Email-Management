...
// plain "field operator value -> category" records, evaluated in priority
// order, first match wins. No nested filter/label graph to reason about.
...
export function categorize(message, rules) {
